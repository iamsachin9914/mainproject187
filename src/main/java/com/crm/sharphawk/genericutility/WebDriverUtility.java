...
public class WebDriverUtility implements IConstants
{
	...
	{
		driver.manage().timeouts().implicitlyWait(ImplictTimeout, TimeUnit.SECONDS);
	}
	...
	/**
	 * used to close the Alert Window
	 * @param driver
	 */
	public void swithToAlertWindowAndAccpectWithoutCondition(WebDriver driver)
	{
		Alert alt = driver.switchTo().alert();
